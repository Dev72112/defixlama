    ...
    return (
      <div className={cn("stat-card", className)}>
        <div className="space-y-2 sm:space-y-3">
          <div className="skeleton h-3 sm:h-4 w-20 sm:w-24" />
          <div className="skeleton h-6 sm:h-8 w-24 sm:w-32" />
          <div className="skeleton h-3 sm:h-4 w-16 sm:w-20" />
        </div>
      </div>
    );
  }
    ...
    <div className={cn("stat-card card-hover group glow-neon-hover", className)}>
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <p className="text-xs sm:text-sm font-medium text-muted-foreground group-hover:text-muted-foreground/80 transition-colors">{title}</p>
          <p className="text-lg sm:text-xl md:text-2xl font-bold text-foreground tabular-nums group-hover:text-gradient-primary transition-all">
            {value}
          </p>
        </div>
        {Icon && (
          <div className="rounded-lg bg-primary/10 p-2 sm:p-2.5 text-primary group-hover:bg-primary group-hover:text-primary-foreground group-hover:scale-110 group-hover:shadow-lg transition-all duration-300">
